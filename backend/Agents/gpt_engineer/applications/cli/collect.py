...
Dependencies:
    ...
    Agents.gpt_engineer.core: Core functionalities of gpt-engineer.
    Agents.gpt_engineer.cli.learning: Handles the extraction of learning data.
...
from Agents.gpt_engineer.applications.cli.learning import (
    Learning,
    Review,
    extract_learning,
    human_review_input,
