...
def build_or_update_index(doc_id, full_text, chroma_dir="./chroma_store", name="backend_skeleton"):
...
def index_repository(name, chroma_dir):
    ...
    for file_path in files:
        try:
            with open(file_path, "r", encoding="utf-8") as f:
                ...
                build_or_update_index(doc_id, content, chroma_dir=chroma_dir, name=name)
...
if __name__ == "__main__":
    TARGET_DIRS = ["Docs/frontend"]
    name = "knowledge_requirementsplanner_frontend"
    index_repository(name, "./chroma_store_frontend")
