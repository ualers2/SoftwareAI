...
const navigationItems = [
  ...
  { 
    ...
    url: "/chat", 
    icon: GitPullRequest,
    description: "Controle seus agentes conversando"
  },
  { 
    title: "Pull Requests", 
    url: "/prs", 
  ...
  { 
    ...
    url: "/tasks", 
    icon: GitPullRequest,
    description: "Monitoramento de Tarefas dos agentes"
  },
  { 
    title: "Workflows", 
    url: "/workflows", 
    ...
    <Sidebar collapsible="icon">
      <SidebarHeader className="border-b border-sidebar-border">
        <div className="flex items-center gap-3 px-4 py-3">
          ...
          {!isCollapsed && (
            <div>
              <h2 className="text-lg font-bold text-sidebar-foreground">Software AI</h2>
              <p className="text-xs text-sidebar-foreground/60">Governe ou Crie Softwares End-to-End</p>
            </div>
          )}
        </div>
      </SidebarHeader>
