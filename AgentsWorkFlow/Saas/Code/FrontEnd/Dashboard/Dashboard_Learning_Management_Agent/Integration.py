...
async def on_handoff(ctx: RunContextWrapper[None], input_data: FrontEndData):
    print(f"Dashboard_Learning_Management_Agent: {input_data.FrontEndContent}")

              
def Dashboard_Learning_Management_Agent(
                                    session_id, 
                                    appcompany,
                                    path_ProjectWeb,
                                    path_html,
    ...
    agent_ids = ['Dashboard_Learning_Management_Agent']
