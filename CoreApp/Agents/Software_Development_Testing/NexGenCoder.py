...
class SoftwareDevelopment_NexGenCoder:
    ...
    def AI_NexGenCoder(
        ...
        AI_NexGenCoder, instructionsassistant, nameassistant, model_select = AutenticateAgent.create_or_auth_AI(appfb, client, key, instructionNexGenCoder, nameassistant, model_select, NexGenCoder_tools, vectorstore_in_assistant)
