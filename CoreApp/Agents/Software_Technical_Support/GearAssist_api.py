...
@app.route('/api/GearAssist/Support/Technical', methods=['POST'])
def GearAssist_Support_Technical():
    ...
    GearAssist_Technical_Support_AI, instructionsassistant, nameassistant, model_select = AutenticateAgent.create_or_auth_AI(appfb, client, key, instruction_GearAssist, nameassistant, model_select, tools_GearAssist)
