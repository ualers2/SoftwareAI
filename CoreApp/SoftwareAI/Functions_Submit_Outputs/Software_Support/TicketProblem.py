...
def submit_output_TicketProblem(function_name,
    ...
    def GearAssist_Technical_Support_api(Ticketid):
        url = "http://127.0.0.1:100/api/GearAssist/Support/Technical"
        payload = {
            "Ticketid": f"{Ticketid}" 
        }
        headers = {
    ...
    functions_map = {
        "OpenSupportTicketProblem": OpenSupportTicketProblem,
        "GearAssist_Technical_Support": GearAssist_Technical_Support_api,
        "CloseSupportTicketProblem": CloseSupportTicketProblem,
        "RecordCSAT": RecordCSAT
    }
